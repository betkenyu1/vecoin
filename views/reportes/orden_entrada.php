...
if ($resultados) {
    ...
    $pdf->Cell(15, 5, utf8_decode('U.Medida'), 1, 0, 'C', false);
    $pdf->Cell(55, 5, utf8_decode('Producto'), 1, 0, 'C', false);
    $pdf->Cell(30, 5, utf8_decode('Nro. Factura'), 1, 0, 'C', false);
    $pdf->Cell(55, 5, utf8_decode('Proveedor'), 1, 0, 'C', false);
    $pdf->Cell(20, 5, utf8_decode('Costo'), 1, 0, 'C', false);
    $pdf->Cell(30, 5, utf8_decode('Monto'), 1, 1, 'C', false);
    foreach ($resultados as $re) {
        $pdf->SetFont('Arial', 'I', 8);
        $pdf->Cell(10, 5, utf8_decode($re["cantidad"]), 1, 0, 'C', false);
        $pdf->Cell(15, 5, utf8_decode($re["umedida"]), 1, 0, 'C', false);
        $pdf->Cell(55, 5, utf8_decode($re["producto"]), 1, 0, 'L', false);
        $pdf->Cell(30, 5, utf8_decode($re["precio"]), 1, 0, 'C', false);
