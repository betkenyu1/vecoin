...
function setNuevoProducto() {
	...
	html += '<select class="default-select2 form-control" name="IdProveedor" id="IdProveedor"></select>';
	...
	html += '<select class="default-select2 form-control" name="IdUMedida" id="IdUMedida"></select>';
	...
	html += '<select class="default-select2 form-control" name="IdCatalogo" id="IdCatalogo"></select>';
	...
	html += '<input type="text" class="form-control" id="IdCant_act" onkeypress="return validarEnteros(event)" placeholder="Ingrese Cantidad Actual">';
	...
	html += '<input type="text" class="form-control" id="IdPrecio_act" onkeypress="return validarCosto(event)" onkeyup="CalcularUtilidad();" placeholder="Ingrese Costo del Producto">';
	...
	html += '<input type="text" class="form-control" id="IdUtilidad" onkeyup="CalcularUtilidad();" onkeypress="return validarUtilidad(event)"placeholder="Utilidad del producto">';
	...
	html += '<input type="text" disabled class="form-control" placeholder="P.V.P. Calculado" id="IdPVP">';
...
function setModificarProducto(id_producto) {
	...
	html += '<select class="default-select2 form-control" name="IdProveedorMod" id="IdProveedorMod"></select>';
	html += '<div id="alert-prov"></div>';
	html += '</div>';
	html += '</div>';
	...
	html += '<div class="mb-10px">';
	html += '<b style="color: #000000;">Unidad de Medida:</b> </br>';
	html += '<select class="default-select2 form-control" name="IdUMedidaMod" id="IdUMedidaMod"></select>';
	html += '<div id="alert-um"></div>';
	html += '</div>';
	html += '</div>';
	...
	html += '<div class="mb-10px">';
	html += '<b style="color: #000000;">Producto:</b> </br>';
	html += '<select class="default-select2 form-control" name="IdCatalogoMod" id="IdCatalogoMod"></select>';
	html += '<div id="alert-cat"></div>';
	html += '</div>';
	html += '</div>';
	...
	html += '<div class="mb-10px">';
	html += '<b style="color: #000000;">Cantidad:</b> </br>';
	html += '<input type="text" class="form-control" id="IdCant_actMod" onkeypress="return validarEnterosMod(event)" placeholder="Ingrese Cantidad Actual">';
	html += '<div id="alert-cant"></div>';
	html += '</div>';
	html += '</div>';
	...
	html += '<div class="mb-10px">';
	html += '<b style="color: #000000;">Costo de Producto ($):</b> </br>';
	html += '<input type="text" class="form-control" id="IdPrecio_actMod" onkeypress="return validarCostoMod(event)" onkeyup="CalcularUtilidadMod();" placeholder="Ingrese Costo del Producto">';
	html += '<div id="alert-costo"></div>';
	html += '</div>';
	html += '</div>';
	...
	html += '<div class="mb-10px">';
	html += '<b style="color: #000000;">Utilidad Deseada (%):</b> </br>';
	html += '<input type="text" class="form-control" id="IdUtilidadMod" onkeyup="CalcularUtilidadMod();" onkeypress="return validarUtilidadMod(event)"placeholder="Utilidad del producto">';
	...
	html += '<div class="mb-10px">';
	html += '<b style="color: #000000;">P.V.P. al Consumidor ($):</b> </br>';
	html += '<input type="text" disabled class="form-control" placeholder="P.V.P. Calculado" id="IdPVPMod">';
	html += '<div id="alert-pvp"></div>';
	html += '</div>';
	html += '</div>';
