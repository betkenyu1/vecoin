        ...
        <div class="login-content">
            <form>
                <div class="form-floating mb-20px">
                    <input type="text" class="form-control fs-13px h-45px border-0" placeholder="Usuario" id="id_usuario" />
                    <label for="id_usuario" class="d-flex align-items-center text-gray-600 fs-13px">Usuario</label>
                </div>
                <div id="alert-usr"></div>
                <div class="form-floating mb-20px">
                    <input type="password" id="id_password" class="form-control fs-13px h-45px border-0" placeholder="Password" />
                    <label for="id_password" class="d-flex align-items-center text-gray-600 fs-13px">Password</label><br>
                    <div class="checkboxvai"><input onclick="RecuperarPassword();" type="checkbox"> Recuperar contraseña.</div>
                </div>
