  ...
  $.ajax({
    ...
    success: function (response) {
      $.each(response, function (key, value) {
        ...
        html += "<td>";
        html +=
          '<a class="btn btn-outline-warning" onclick="setModificarProveedor(' +
          value.id_proveedor +
          ');" title="Modificar"><i class="fa fa-pencil" aria-hidden="true"></i></a>';
        html +=
          '&nbsp;<a class="btn btn-outline-danger" onclick="getEliminarProveedor(' +
          value.id_proveedor +
...
function setProveedor() {
  ...
  html +=
    '<input type="text"   class="form-control" minlength="13" onkeypress="return validarRUC(event)" placeholder="Ingrese R.U.C." id="IdRuc">';
...
function setModificarProveedor(id_proveedor) {
  ...
  html += '<div class="text-center">';
  html +=
    '<a class="btn btn-outline-danger" onclick="CerrarModificarProveedor();" title="Cerrar"><i class="fa-solid fa-cancel" aria-hidden="true"></i> Cerrar</a>';
  html +=
    '&nbsp;<a class="btn btn-outline-primary" title="Modificar" onclick="getModificarProveedor();"><i class="fa-solid fa-pencil" aria-hidden="true"></i> Modificar</a>';
  html += "</div>";
