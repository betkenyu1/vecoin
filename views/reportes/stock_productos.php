...
if ($resultados) {
    ...
    $pdf->Cell(190, 5, 'CANTIDADES DISPONIBLES A LA FECHA DE IMPRESION', 1, 1, 'C', true);
    ...
    $pdf->Cell(20, 5, utf8_decode('Valorización'), 1, 0, 'C', false);
    ...
    foreach ($resultados as $re) {
        ...
        $pdf->Cell(20, 5, utf8_decode($re["valorizacion"]), 1, 0, 'C', false);
        $pdf->Cell(30, 5, utf8_decode($re["id_estado"]), 1, 1, 'C', false);
    }
    $pdf->SetFont('Arial', 'B', 10);
