  ...
  $.ajax({
    ...
    success: function (response) {
      $.each(response, function (key, value) {
        ...
        html += '<td>';
        html += '<a data-bs-toggle="modal" data-bs-target="#cargaFotoPerfil" onclick="capturarID(' + value.id_usuario + ')" class="btn btn-outline-warning"  title="Modificar Foto Perfil"><i class="material-icons">account_box</i></a>';
        html += '&nbsp;<a data-bs-toggle="modal" data-bs-target="#cargaFotoFondo" onclick="capturarIDFondo(' + value.id_usuario + ')" class="btn btn-outline-success"  title="Modificar Foto Fondo"><i class="material-icons">contact_emergency</i></a>';
