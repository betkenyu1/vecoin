...
<div id="content" class="app-content">
    ...
    <div class="panel panel-inverse">
        <div class="panel-heading">
            <h4 class="panel-title">CATÁLOGO DE EMPLEADOS</h4>
        ...
        <div class="panel-body">
            <a href="#new?1" onclick="setEmpleados();" class="btn btn-success"><i class="fa fa-plus" aria-hidden="true"></i> Agregar Empleado</a>
            <hr>
